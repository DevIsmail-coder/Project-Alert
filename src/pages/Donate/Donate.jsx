        ...
        <div className='footer2Wrapper'>
          ...
          <div className='motivationCards'>
            ...
            <span className='motivationCard'>
              <div className='icon'><GiLifeSupport size={70} color='#7f47bf' /></div>
            ...
            <span className='motivationCard'>
              <div className='icon'><FaRibbon size={70} color='#7f47bf' /></div>
              <div className='tittle'>
            ...
            <span className='motivationCard'>
              <div className='icon'><MdLibraryBooks size={70} color='#7f47bf' /></div>
              <div className='tittle'>
                <h1>Reasearch & </h1>
                <h2> Documentation</h2>
              </div>
